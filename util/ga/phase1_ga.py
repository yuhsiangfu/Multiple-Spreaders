...
def locus_based_genetic_algorithm(G, num_generation=100, size_population=100, rate_selection=0.1, rate_crossover=0.5, rate_mutation=0.05, show_progress=False):
    if show_progress:
        show_msg(' ----- Phase 1: determine number of clusters')
    else:
        pass
