...
def standard_genetic_algorithm(G, num_community=2, num_evolution=1, num_generation=100, size_population=100, rate_selection=0.1, rate_crossover=0.5, rate_mutation=0.05, show_progress=False):
    # initial variables
    evo_best = []
    best_list = []
    time_list = []

    G = initialization(G, num_community)
