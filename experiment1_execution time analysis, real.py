...
def main_function():
    ...
    for net in FILENAME_LIST:
        ...
        #
        lga_path = FOLDER_FILE + net[0] + ', experiment1-real-lga.pickle'
        ...
        #
        sga_path = FOLDER_FILE + net[0] + ', experiment1-real-sga.pickle'
        ...
        #
        tpef_path = FOLDER_FILE + net[0] + ', experiment1-real-tpef.pickle'
